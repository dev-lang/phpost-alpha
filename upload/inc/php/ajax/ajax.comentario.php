...
\*********************************/
	...
	switch($action){
		case 'comentario-preview':
            ...
            if($tsText == '') die('0: El campo <b>Comentario</b> es requerido para esta operaci&oacute;n');
            //
			$auser = $_POST['auser'];
			$preview = array(0,$tsCore->parseBBCode($comentario),'',time(),$auser, $comentario);
		...
		case 'comentario-ajax':
			...
			$tsComments = array('num' => $tsComments['num'], 'data' => $tsComments['data'], 'autor' => $tsAutor);
