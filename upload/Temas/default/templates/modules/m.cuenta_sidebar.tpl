...
*********************************************************************************
					...
					<div class="sidebar-tabs clearbeta">
                        ...
                        <ul class="change-avatar" style="display: none;">
                        	...
                        	<li class="url-file">
                                ...
                                {else}
                                    Lo sentimos por el momento solo puedes sibir avatares desde tu PC.
                                {/if}
                                </div>
                            </li>
                        </ul>
                    ...
                    <div style="margin-top:5px;text-align:center;font-size:13px;margin-bottom:10px;color:#FFF;text-shadow: 0 1px 0px #000" id="porc-completado">
                        <div style="background: #CCC;padding:2px;line-height:17px">
                            <div style="width: {$tsPerfil.porcentaje}%; height:17px;border-right:1px solid #004b8d; border-left: 1px solid #004b8d;background: url('http://o2.t26.net/images/barra.gif') top left repeat-x;" id="porc-completado-barra">
                            </div>
                        </div>
                    </div>
                    <div id="prueba"></div>