...
*********************************************************************************
                            ...
                            <ul class="mpHistory" id="historial">
                                ...
                                <li>
                                    <div class="main clearBoth">
                                        ...
                                        <div class="mensaje">
                                            <div><a href="{$tsConfig.url}/perfil/{$mp.user_name}" class="autor-name">{$mp.user_name}</a> <span class="mp-date">{$mp.mr_date|fecha}</span></div>
                                            <div>{$mp.mr_body|nl2br}</div>
                                        </div>
                                    </div>
                                </li>
                                {/foreach}{else}
                                <li class="emptyData">No se pudo cargar los mensajes.</li>
                                {/if}
                            </ul>
                            <div class="mpForm">
                                <div class="form">
                        ...
                        <div class="mpOptions">
                            ...
                            <ul class="actions-list">
                                ...
                                <li class="div"></li>
                                <li><a href="#" onclick="denuncia.nueva('usuario',{if $tsMensajes.msg.mp_from != $tsUser->uid}{$tsMensajes.msg.mp_from}{else}{$tsMensajes.msg.mp_to}{/if}, '', '{if $tsMensajes.msg.mp_from != $tsUser->uid}{$tsMensajes.msg.user_name}{else}{$tsUser->getUsername($tsMensajes.msg.mp_to)}{/if}'); return false">Deunciar a este usuario...</a></li>
