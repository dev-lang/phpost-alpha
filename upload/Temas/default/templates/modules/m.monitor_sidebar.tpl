...
*********************************************************************************
                ...
                <div style="width: 210px; float: right;" id="post-izquierda">
                    ...
                    <div class="categoriaList estadisticasList">
                        ...
                        <ul>
                            <li class="clearfix"><a href="{$tsConfig.url}/monitor/seguidores"><span class="floatL">Seguidores</span><span class="floatR number">{$tsUser->info.user_seguidores}</span></a></li>
                            <li class="clearfix"><a href="{$tsConfig.url}/monitor/siguiendo"><span class="floatL">Usuarios Siguiendo</span><span class="floatR number">{$tsUser->info.user_siguiendo}</span></a></li>
                            ...
                            <li class="clearfix"><a href="{$tsConfig.url}/perfil/{$tsUser->nick}"><span class="floatL">Medallas</span><span class="floatR number">{$tsUser->info.user_medallas}</span></a></li>
                        </ul>
                    </div>
