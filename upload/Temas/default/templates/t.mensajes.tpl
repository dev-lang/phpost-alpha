                    ...
                    <div class="boxy">
                        <div class="boxy-title">
                            ...
                            <form method="get" action="{$tsConfig.url}/mensajes/search/">
                                <input type="text" name="qm" onfocus="onfocus_input(this)" onblur="onblur_input(this)" title="Buscar en Mensajes" value="Buscar en Mensajes" class="search_mp onblur_effect"/>
                            </form>
                        </div>
                        <div class="boxy-content" style="padding:0" id="mensajes">
                            {if $tsAction == '' || $tsAction == 'enviados' || $tsAction == 'respondidos'}
