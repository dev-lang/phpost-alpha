            ...
            <div id="showResult">
                <table class="linksList">
                    ...
                    <tr id="div_{$r.post_id}">
                        <td title="{$r.c_nombre}" style="background:url({$tsConfig.url}/Temas/default/images/icons/cat/{$r.c_img}) no-repeat center center;">&nbsp;</td>
                        <td style="text-align: left;">
                            ...
                            <div class="info" style="background-color:#FFF">
                                <img alt="Creado hace" src="http://o2.t26.net/search/clock.png"/> <strong>{$r.post_date|hace:true}</strong> -
                                <img alt="Posts relacionados" src="http://o2.t26.net/search/relacionados.png"/> <a href="{$tsConfig.url}/buscador/?q={$r.post_title}&e={$tsEngine}&cat={$tsCategory}&autor={$tsAutor}">Post Relacionados</a> -
                                <img alt="Creado por" src="http://o2.t26.net/search/autor.png"/> <a href="{$tsConfig.url}/perfil/{$r.user_name}">{$r.user_name}</a> |
                                <img alt="0 puntos" src="http://o2.t26.net/search/puntos.png"/> Puntos <strong>{$r.post_puntos}</strong> -
                                <img alt="0 puntos" src="http://o2.t26.net/search/favoritos.gif"/> <strong>{$r.post_favoritos}</strong> Favoritos -
                                <img alt="0 puntos" src="http://o2.t26.net/search/comentarios.gif"/> <strong>{$r.post_comments}</strong> Comentarios
                            </div>
                        </td>
                    </tr>
                    {/foreach}
