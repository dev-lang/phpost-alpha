                                ...
                                {if $tsSave}<div style="display: block;" class="mensajes ok">Tus cambios han sido guardados.</div>{/if}
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.post_id}">
                                            	<td>{$r.total}</td>
                                                <td><a href="{$tsConfig.url}/posts/{$r.c_seo}/{$r.post_id}/{$r.post_title|seo}.html" target="_blank">{$r.post_title}</a></td>
                                                ...
                                                <td class="admin_actions">
                                                    ...
                                                    <a href="#" onclick="mod.reboot({$r.post_id}, 'posts', 'reboot', false); return false;"><img src="{$tsConfig.default}/images/icons/reboot.png" title="{if $r.post_status == 1}Reactivar Post{else}Desechar denuncias{/if}" /></a>
                                                    <a href="{$tsConfig.url}/agregar.php?action=editar&pid={$r.post_id}" target="_blank"><img src="{$tsConfig.default}/images/icons/edit.png" title="Editar Post" /></a>
                                                    <a href="#" onclick="mod.posts.borrar({$r.post_id}, false); return false"><img src="{$tsConfig.default}/images/icons/close.png" title="Borrar Post" /></a>
                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
                                    ...
                                    <h2 style="border-bottom:1px dashed #CCC; padding-bottom:5px;">
                                        ...
                                        <span class="floatR admin_actions">
                                            ...
                                            <a href="#" onclick="mod.reboot({$tsDenuncia.data.post_id}, 'posts', 'reboot', true); return false"><img src="{$tsConfig.default}/images/icons/reboot.png" title="{if $tsDenuncia.data.post_status == 1}Reactivar Post{else}Desechar denuncias{/if}" /></a>
                                            <a href="{$tsConfig.url}/agregar.php?action=editar&pid={$tsDenuncia.data.post_id}" target="_blank"><img src="{$tsConfig.default}/images/icons/edit.png" title="Editar Post" /></a>
                                            <a href="#" onclick="mod.posts.borrar({$tsDenuncia.data.post_id}, 'posts', true); return false"><img src="{$tsConfig.default}/images/icons/close.png" title="Borrar Post" /></a>
                                        </span>
                                    </h2>
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center">
                                    	<thead>
