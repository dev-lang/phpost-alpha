        ...
        <div id="menu">
			...
			<ul class="menuTabs">
                ...
                <li class="tabbed {if $tsPage == 'posts' || $tsPage == 'home'}here{/if}" id="{if $tsConfig.c_allow_portal && $tsUser->is_member}tabbedposts{else}tabbedhome{/if}">
                    <a title="Ir a Posts" onclick="menu('posts', this.href); return false;" href="{$tsConfig.url}/posts/">Posts <img alt="Drop Down" src="http://o2.t26.net/images/arrowdown.png"></a>
                </li>
                <li class="tabbed {if $tsPage == 'fotos'}here{/if}" id="tabbedfotos">
                    <a title="Ir a Fotos" onclick="menu('fotos', this.href); return false;" href="{$tsConfig.url}/fotos/">Fotos <img alt="Drop Down" src="http://o2.t26.net/images/arrowdown.png"></a>
                </li>
                <li class="tabbed {if $tsPage == 'tops'}here{/if}" id="tabbedtops">
                    <a title="Ir a TOPs" onclick="menu('tops', this.href); return false;" href="{$tsConfig.url}/top/">TOPs <img alt="Drop Down" src="http://o2.t26.net/images/arrowdown.png"></a>
                </li>
                {if $tsUser->is_member}
                    {if $tsUser->info.user_rango == 1}
                <li class="tabbed {if $tsPage == 'admin'}here{/if}" id="tabbedAdmin">
                    <a title="Ir a Administraci&oacute;n" onclick="menu('Admin', this.href); return false;" href="{$tsConfig.url}/admin/">Administraci&oacute;n <img alt="Drop Down" src="http://o2.t26.net/images/arrowdown.png"></a>
                </li>
   	                {/if}
                {else}
                	...
                	<div class="login_cuerpo">
    	              ...
    	              <div id="login_error" style="display: none; padding:3px 0;"></div>
                	    ...
                	    <div class="login_footer">
	                      <a href="#" onclick="remind_password()">¿Olvidaste tu contrase&ntilde;a?</a>
        	                <br/>
