...
<div class="hovercard-inner">
    <div class="bd">
        ...
        <div class="bio">
            ...
            <p class="location">
                <img title="{$tsData.status.t}" class="status {$tsData.status.css} vctip" src="http://taringa.com/Temas/default/images/space.gif"/>
                ...
                {if $tsUser->is_member}<a onclick="mensaje.nuevo('{$tsData.user_name}','','','');return false" href="#"><img src="{$tsConfig.default}/images/icon-mensajes-recibidos.gif" title="Enviar mensaje privado" class="vctip"/></a>{/if}
            </p>
        </div>
