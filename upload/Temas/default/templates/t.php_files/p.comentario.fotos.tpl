...
<div class="item" id="div_cmnt_{$tsComment.0}">
    <a href="{$tsConfig.url}/perfil/{$tsUser->nick}">
        <img src="{$tsConfig.url}/files/avatar/{if $tsUser->info.user_avatar}{$tsUser->info.user_id}_50{else}avatar_50{/if}.jpg" width="50" height="50" class="floatL" />
    </a>
    <div class="firma">
        <div class="options">
