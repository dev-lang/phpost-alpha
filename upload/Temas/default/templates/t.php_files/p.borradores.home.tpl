                ...
                <div id="borradores">
                    ...
                    <div id="template-result-borrador" style="display:none">
                        <li id="borrador_id___id__">
                            <a title="__categoria_name__" class="categoriaPost __categoria__ __tipo__" href="__url__" onclick="__onclick__" style="background-image:url({$tsConfig.url}/Temas/default/images/icons/cat/__imagen__)">__titulo__</a>
